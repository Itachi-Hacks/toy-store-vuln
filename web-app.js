            ...
            <form method="POST" action="/process-payment" id="paymentForm">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="expiry_date" placeholder="12/25" maxlength="5" pattern="[0-9]{2}/[0-9]{2}" required>
                    </div>
                </div>
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="billing_zip" placeholder="10001" maxlength="10" required>
                    </div>
                </div>
...
app.post('/process-payment', async (req, res) => {
    ...
    const { amount, card_number, card_holder, cvv, expiry_date, billing_zip, address, phone } = req.body;
    ...
    try {
        ...
        try {
            await client.query(
                'INSERT INTO payments (order_id, amount, card_number, card_holder, cvv, expiry_date, billing_zip, method, status) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)',
                [orderId, amount, card_number, card_holder, cvv, expiry_date || 'N/A', billing_zip || 'N/A', 'card', 'completed']
            );
        } catch (colErr) {
            // If expiry_date/billing_zip columns don't exist, insert without them
            await client.query(
...
app.post('/admin/users/delete/:id', async (req, res) => {
    ...
    try {
        ...
        // 1. Delete payments for user's orders
        await client.query(`
        ...
        // 5. Delete cart items (should cascade but let's be explicit)
        await client.query('DELETE FROM cart_items WHERE user_id = $1', [userId]);
        
        // 6. Delete wishlist items (should cascade but let's be explicit)
